...
int newfd;
 ...
 void * ServerFunction(void * parameter)
 {
    ...
    {
    	char *message = "The provided files are : file1.txt, file2.txt, file3.txt --> Please make your choice."; 
		...
		n=recv(info->newfd, (char *)temp, 100,0);
		char *ask="Do you want more files ? (yes/no)";
